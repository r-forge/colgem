...
heights <- seq(0, 40, length.out=21) #TODO how to pick range & resolution is an open question
...
ESTNAMES <- c('alpha', 'beta0', 'beta1', 'beta2', 'I0_0')
...
{ # compare stoch and det trajectories
	...
	plot(times0, ydet[1,], type='lines', col='black', ylim=c(0,800))
...
if (TRUE)
{
	...
	X11(); plot(times0, Ys[, 'I0'], type='lines', ylim = c(0, 800))
